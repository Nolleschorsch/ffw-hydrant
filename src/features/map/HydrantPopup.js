...
export const HydrantPopup = props => {
    ...
    const { index, dispatchEditHydrant, changeName, confirm, abort, deleteHydrant, ...hydrant } = props
    const { name, lng, lat, active } = hydrant

    //console.log('hydrpopup', props, newName)
            ...
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Body>
                    <Form.Group className="mb-3">
                        ...
                        {/*                     <Form.Control id="hydrant-pop-name" value={newName} onChange={handleChangeName} placeholder="Hydrantbezeichnung eintragen" />
 */}
